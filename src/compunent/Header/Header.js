    ...
    return (
        <>
            <Navbar bg="dark" variant="dark" sticky="top" collapseOnSelect expand="lg" >
                <Container>
                    <Navbar.Brand href="#home" className="fw-bold">Sultan <span className="text-warning">Hospital</span></Navbar.Brand>
                    <Navbar.Toggle />
                    <Navbar.Collapse className="justify-content-end ">
                        ...
                        {user.email ?
                            <div>
                                <img src={user.photoURL} alt="mdo" width="32" height="32" class="rounded-circle me-3" />
                                <Navbar.Text>
